...
public class Catalog {
    ...
    private void initItems() {
      items.put("hall001",new CatalogItem
      (CatalogItem.TECH,
       "hall001",
       ...
       39.95));
      items.put("hall002", new CatalogItem
        (CatalogItem.TECH,
         "hall002",
         ...
         49.99));
      items.put("lewis001", new CatalogItem
        (CatalogItem.KIDS,
         "lewis001",
         "The Chronicles of Narnia by C.S. Lewis",
           ...
           "spiritual allegory.",
         19.95));
      items.put("alexander001",new CatalogItem
        (CatalogItem.KIDS,
         "alexander001",
         "The Prydain Series by Lloyd Alexander",
           ...
           "the way.",
         19.95));
      items.put("rowling001",new CatalogItem
        (CatalogItem.KIDS,
         "rowling001",
